...
var InfodataManager = require('./lib.manager.infodataManager')
...
module.exports = class ManagerDisposer extends Base
{
    ...
    createInfodataManager()
    {
        this.logVerbose("Creating infodata manager")
        this.infodataManager = new InfodataManager()
        this.infodataManager.parmLogger(this.parmLogger())
        this.infodataManager.parmManagerDisposer(this)
    }  
