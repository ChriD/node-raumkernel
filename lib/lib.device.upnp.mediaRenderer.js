    ...
    {    
        ...
        return new Promise(function(resolve, reject){
            ...
            if(_triggerData.values)
            {
                ...
                {
                    if(self.rendererState[_triggerData.key].toString().toLowerCase() == _triggerData.values[i].toString().toLowerCase())
                        keyAlreadySet = true
                }
            }
            else
            {
                keyAlreadySet = self.rendererState[_triggerData.key].toString().toLowerCase() == _triggerData.value.toString().toLowerCase()
            }
