...
module.exports = class UPNPMediaRenderer extends UPNPDevice
{
    ...
    /**
     * returns a random update id
     * @return {Integer} a random integer between min and max range
     */
    ...
    {
        this.lastUpdateIdRendererState = parseInt(this.lastUpdateIdRendererState) + 1;
    }
