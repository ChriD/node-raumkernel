...
module.exports = class UPNPMediaRenderer extends UPNPDevice
{
     ...
     * @return {Promise} a promise with no result
     */
    setPlayMode(_playMode, _confirm)
    {
     ...
     */
    callActionWithTriggerWait(_service, _action, _params, _resultSetFunction = null, _triggerData = null, _waitForTrigger = false, _triggerContext = 'renderer', _triggerType = 'rendererStateKeyValueChanged', _timeout = 3500)
