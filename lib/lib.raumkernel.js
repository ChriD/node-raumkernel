...
module.exports = class Raumkernel extends BaseManager
{
    ...
    init()
    {
        ...
        this.managerDisposer.deviceManager.on("currentMediaItemDataChanged",        function(_mediaRenderer, _mediaItemData)                { self.onCurrentMediaItemDataChanged(_mediaRenderer, _mediaItemData); } );
        ...
        this.managerDisposer.mediaListManager.on("mediaListReady",                  function(_id, _mediaList)       { self.onMediaListReady(_id, _mediaList); } );
        this.managerDisposer.mediaListManager.on("mediaRendererPlaylistReady",      function(_id, _mediaList)       { self.onMediaRendererPlaylistReady(_id, _mediaList); } );
    ...
    onMediaListReady(_id, _mediaList)
    {
        this.emit("mediaListReady", _id, _mediaList);
    }
    
    
    onMediaRendererPlaylistReady(_id, _mediaList)
    {
        this.emit("mediaRendererPlaylistReady", _id, _mediaList);
    }
    
    
    onCurrentMediaItemDataChanged(_mediaRenderer, _currentMediaItemData)
    {
        this.emit("currentMediaItemDataChanged", _mediaRenderer, _currentMediaItemData);
    }
