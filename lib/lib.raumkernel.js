...
module.exports = class Raumkernel extends BaseManager
{
    ...
    init()
    {
        ...
        this.managerDisposer.deviceManager.on("rendererStateKeyValueChanged",       function(_mediaRenderer, _key, _oldValue, _newValue)    { self.onRendererStateKeyValueChanged(_mediaRenderer, _key, _oldValue, _newValue, _roomUdn); } );
    ...
    onRendererStateKeyValueChanged(_mediaRenderer, _key, _oldValue, _newValue, _roomUdn)
    {
        ...
        this.managerDisposer.triggerManager.trigger("renderer", "rendererStateKeyValueChanged", {  "renderer": _mediaRenderer.udn(),
                                                                                    "key": _key,  
                                                                                    "value": _newValue,
                                                                                    "oldValue": _oldValue,
                                                                                    "roomUdn": _roomUdn });
