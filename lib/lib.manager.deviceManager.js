...
module.exports = class DeviceManager extends ManagerBase
{
    ...
    discover()
    {
        ...
        // we do start for searching the raunfeld host by searching for the configuration device
        this.logInfo("Start searching for raumfeld host");
        this.ssdpClient.search('urn:schemas-raumfeld-com:device:ConfigDevice:1'); 
