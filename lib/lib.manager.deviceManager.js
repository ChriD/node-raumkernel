...
module.exports = class DeviceManager extends ManagerBase
{
    ...
    discoverHostBonjour()
    {
        ...
        self.bonjourClientBrowser = self.bonjourClient.find({}, function (_service) {
            if(_service.fqdn.startsWith("RaumfeldControl"))
            {
                ...
                // do not stop discovering of the host
        ...
        setTimeout( function(){
            if(!self.systemHostFound)
            {
                ...
                self.logWarning("Raumfeld host not found. Starting discovery with ssdp!");
    ...
    discoverHostSSDP()
    {
        ...
        setInterval( function(){
            ...
            {                
                ...
                self.logWarning("Raumfeld host not found. Be sure you have started the host and that you have connection to the network!");
                //self.ssdpClient.search('urn:schemas-raumfeld-com:device:ConfigDevice:1');                 
                //self.discoverHostBonjour();
            }
    ...
    existsInDeviceList(_udn)
    {
        ...
        for(var i=0; i<this.deviceList.devices.length; i++)
        {
