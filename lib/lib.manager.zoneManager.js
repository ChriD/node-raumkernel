...
module.exports = class ZoneManager extends ManagerBase
{
    ...
    updateZoneInformationMap()
    {
        ...
        // copy the current information into a temporary map for checkign if a zone was added or removed
        ...
        for (var zoneRootIdx=0; zoneRootIdx<this.zoneConfiguration.zoneConfig.zones.length; zoneRootIdx++)
        {
            ...
            for (var zoneIdx=0; zoneIdx<zoneArray.length; zoneIdx++)
            {
                ...
                for (var roomIdx=0; roomIdx<zoneObject.room.length; roomIdx++)
                {
                    ...
                    roomMapObject.UDN = roomObject.$.udn;
                    roomMapObject.name = roomObject.$.name;
                    roomMapObject.color = roomObject.$.color;
                    roomMapObject.powerState = roomObject.$.powerState;
        ...
        // TODO: handle unassigned rooms, we add them into "" (empty) map key       
