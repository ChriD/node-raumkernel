...
module.exports = class ZoneManager extends ManagerBase
{
    ...
    zoneConfigurationRequest(_updateId = "")
    {
        ...
        var options = {            
            url: "http://" + this.systemHost + ":" + this.getSettings().raumfeldHostRequestPort.toString() + "/getZones",
            headers: {
                'updateId': _updateId
            }
        };
    ...
    connectRoomToZone(_roomUdn, _zoneUdn)
    {
        ...
        return new Promise(function(_resolve, _reject){
            ...
            var options = {                
                url: "http://" + self.systemHost + ":" + this.getSettings().raumfeldHostRequestPort.toString() + "/connectRoomToZone?roomUDN=" + _roomUdn + "&zoneUDN=" + _zoneUdn            
            };
    ...
    async dropRoomFromZone(_roomUdn)
    {
        ...
        return new Promise(function(_resolve, _reject){
            ...
            var options = {                
                url: "http://" + self.systemHost + ":" + this.getSettings().raumfeldHostRequestPort.toString() + "/dropRoomJob?roomUDN="+_roomUdn
            };
