...
module.exports = class ZoneManager extends ManagerBase
{
    ...
    {
        // if there is no "zoneconfig" or the system does not consist of zones at all we have to skip the method
        if(!this.zoneConfiguration || !this.zoneConfiguration.zoneConfig || !this.zoneConfiguration.zoneConfig.zones)
            return ""
