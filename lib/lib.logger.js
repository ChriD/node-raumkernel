...
module.exports = class Logger extends EventEmitter
{
     ...
     */
    constructor(_logLevel, _logPath = "")
    {
        super()
    ...
    initExternalLogger()
    {
        ...
        this.externalLoggerObject = new (Winston.Logger)(
            {                
                ...
                exceptionHandlers: [
                    new (Winston.transports.File)({ filename: this.logPath + '/exceptions.log', handleExceptions: true, humanReadableUnhandledException: true, json: false  })
                ]
            }
        );
