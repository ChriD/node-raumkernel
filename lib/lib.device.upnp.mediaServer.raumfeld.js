...
module.exports = class UPNPMediaServerRaumfeld extends UPNPMediaServer
{
    ...
    { 
        return this.callAction("ContentDirectory", "AddContainerToQueue", { "QueueID" : (_queueId), "ContainerID" : (_containerId), "SourceID" : (sourceId), "SearchCriteria" : _searchCriteria, "SortCriteria" : _sortCriteria, "StartIndex" : _startIndex, "EndIndex" : _endIndex, "Position" : _position });
    }
    ...
    { 
        return this.callAction("ContentDirectory", "AddContainerToQueue", { "QueueID" : (_queueId), "ObjectID" : (_objectId), "Position" : _position });
    }
    ...
    { 
        return this.callAction("ContentDirectory", "AddContainerToQueue", { "QueueID" : (_queueId), "FromPosition" : _fromPosition, "ToPosition" : _toPosition });
    }
    ...
    { 
        return this.callAction("ContentDirectory", "MoveInQueue", { "ObjectID" : (_queueId), "NewPosition" : _newPosition });
    }
